...
urlpatterns = [
	...
	path("projects/<int:project_id>/download/compose/", views.project_download_compose, name="project_download_compose"),
	path("projects/<int:project_id>/download/dockerfile/", views.project_download_dockerfile, name="project_download_dockerfile"),
	path("projects/<int:project_id>/download/bundle/", views.project_download_bundle, name="project_download_bundle"),
